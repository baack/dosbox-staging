...
// TODO: this gives us M_PI on VisualStudio. Remove this once we've defined PI
//       in support.h
...
static std::array<PanScalar, GUS_PAN_POSITIONS> pan_scalars = {};
...
public:
	...
	void WriteRampRate(uint8_t val)
	{
		...
		IncrVolIndex = ceil_udivide(scale, divider);
	}
